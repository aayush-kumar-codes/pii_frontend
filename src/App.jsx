...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    formPayload.append("job_id", formData.jobId);
    formPayload.append("methods", "regex");
    formPayload.append("countries", "US,AR");
    formPayload.append("transformos_method", "pseudonymize");

    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/submit_transform`,
        {
          method: "POST",
          body: formPayload,
        }
